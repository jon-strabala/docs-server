...
+
The details under Bucket "bulk" scope "data" show that we have archive the 1,968 documents and the orginal document set from our N1QL statment has expired:
+
...
+
The details under Bucket "bulk" scope "data":
+
