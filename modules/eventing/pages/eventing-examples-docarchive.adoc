...
When you created the collection *'bulk.data.source'* should have set a 'Bucket Max Time-To-Live' or TTL of 600 seconds.  
If you didn't then drop the collection and recreate it with the needed TTL.
+
