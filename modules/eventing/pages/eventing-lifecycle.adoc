...
In order to show the basic life cycle of an Eventing Function, we need a Listen To Location (a source keyspace) and a seperate Eventing Storage keyspace.
...
== Excercise the Eventing Lifecycle:
