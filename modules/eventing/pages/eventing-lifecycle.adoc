...
| Listen To Location (the source keyspace or collection)
...
| The name of a keyspace currently defined on the cluster.
This collection stores artifacts and checkpoint information.
...
choose to invoke a handler to process only future data mutations. The Feed Boundary is a persistent setting in the 
